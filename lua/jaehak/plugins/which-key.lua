return {
	...
	config = function(_, opts)
		...
		wk.add({
			...
			{'<leader>tm', group = '[Table] Move',             mode = 'n'},
			{'<leader>ts', group = '[Table] Sort',             mode = 'n'},
			{'<leader>tv', group = '[Table] Convert',          mode = 'n'},
			{'<leader>td', group = '[Table] Delete Column',    mode = 'n'},
			{'<leader>ty', group = '[Table] Duplicate Column', mode = 'n'},
			{'<leader>mf', group = '[markdown] Footnote', 	   mode = 'n'},
		})
